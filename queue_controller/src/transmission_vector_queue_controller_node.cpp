...
int main(int argc, char **argv)
{
    ...
    QueueController<METRIC_CONTROL_PREDICTION_SRV, POTENTIAL_ACTION_SET_MSG, POTENTIAL_ACTION_SET_SRV, ACTION_LIB_OUTPUT_TYPE, ACTION_LIB_OUTPUT_GOAL_TYPE, CONTROLLER_COSTS_LIST_TYPE> queue_controller(nh);
