...
$$\left(\begin{aligned}Minimize:\quad & \bar{y}_0\\ Subject\ to:\quad & \bar{y}_l \leq 0\ \forall l \ \in \{1, ..., L\} \\ & \bar{e}_l = 0\ \forall j \ \in \{1, ..., J\} \\& \textrm{Queues} \ Q_{k}(t)\ \textrm{are mean rate stable}\ \forall k \ \in \{1, ..., K\}\end{aligned})$$
